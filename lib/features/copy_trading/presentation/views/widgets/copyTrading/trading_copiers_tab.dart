...
class TradingCopiersTab extends HookWidget {
  final ProTrader trader;
  const TradingCopiersTab({super.key, required this.trader});
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            addHeight(10.h),
            ...List.generate(mockTraders.take(6).length, (index) {
              final trader = mockTraders[index];
              return _buildTradersTile(
                trader,
                index == mockTraders.take(6).length - 1,
              );
            }),
          ],
        ),
